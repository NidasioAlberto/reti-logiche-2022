...
Considerando il flusso $U$ di bit in ingresso e indicando con $k$ l'instante di tempo considerato, la codifica legge il bit $U_k$ e produce i bit $P_{1k}$ e $P_{2k}$ calcolati come mostrato in eq. \ref{eq:p1k} e \ref{eq:p2k}. È importate sottolineare che per produrre i bit P viene applicato l'operatore XOR ($\oplus$) così da ottenere una somma senza riporto.
